## Cursor, Left and Right Click, Scroling with Camera Feed
...
right_click_time = 0
SCROLL_INTERVAL = 0.5
RIGHT_CLICK_COOLDOWN = 1  # seconds
...
def is_right_click(lm, h):
    ...
    ring_down = lm[16].y * h > lm[14].y * h + 15
    pinky_down = lm[20].y * h > lm[18].y * h + 15
...
while True:
    ...
    cv2.imshow("Touchless Interface Alpha (Right Click Added)", frame)
